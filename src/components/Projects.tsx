import { ExternalLink, Github, BarChart3, TrendingUp, Clock, PieChart } from "lucide-react";
...
const projects = [
  {
    ...
    description:
      "Analyzed pizza sales data using SQL and visualized insights in a Power BI dashboard to improve business performance and optimize the menu strategy.",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              Real-world data analysis projects delivering actionable business insights
            </p>
          </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    {project.outcomes.map((outcome) => (
                      ...
                      >
                        ...
                        <h5 className="font-semibold mb-1">{outcome.title}</h5>
